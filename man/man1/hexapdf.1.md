...
if they don't exist yet. As a special exception to the naming rule, if the prefix points to a
directory, the dash between the prefix and the image index is omitted (to avoid files starting with
a dash).
