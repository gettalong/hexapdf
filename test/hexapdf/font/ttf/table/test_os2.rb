...
require 'test_helper'
require 'stringio'
require 'hexapdf/font/ttf/table/os2'

describe HexaPDF::Font::TTF::Table::OS2 do
  before do
    ...
    @entry = HexaPDF::Font::TTF::Table::Directory::Entry.new('OS/2', 0, 0, @file.io.length)
  end
  ...
  describe "initialize" do
    ...
    it "loads some default values if no entry is given" do
      table = HexaPDF::Font::TTF::Table::OS2.new(@file)
      assert_equal(5, table.version)
