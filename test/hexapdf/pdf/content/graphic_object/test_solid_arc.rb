...
describe HexaPDF::PDF::Content::GraphicObject::SolidArc do
  describe "initialize" do
    it "creates a default solid arc representing the disk at the origin" do
      arc = HexaPDF::PDF::Content::GraphicObject::SolidArc.configure
  ...
  describe "configure" do
    it "changes the values" do
      arc = HexaPDF::PDF::Content::GraphicObject::SolidArc.new
