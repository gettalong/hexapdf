...
describe HexaPDF::Type::Annotations::Widget do
  ...
  describe "background_color" do
    it "returns the current background color" do
      ...
      @widget[:MK] = {BG: [1]}
      assert_equal([1], @widget.background_color.value)
    end

    it "sets the color and returns self" do
      assert_same(@widget, @widget.background_color([1]))
      assert_equal([1], @widget.background_color.value)
    end
  end
  ...
  describe "border_style" do
    ...
    describe "setter" do
      ...
      it "sets the color" do
        @widget.border_style(color: [1, 0, 1])
        assert_equal([1, 0, 1], @widget[:MK][:BC].value)
      end
      ...
      it "overrides all priorly set values" do
        ...
        assert_equal([0], border_style.color)
      end
